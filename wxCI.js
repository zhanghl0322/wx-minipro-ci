 ...
 * buildId: 构建id
 */
const { type='publish', version = '2.2.2.2', desc = 'CI机器人测试', appid = 'appid', buildId='1' } = getEnvParams(process.argv);
...
const privateKeyPath = `D:\\Code\\private.${appid}.key`;

// 请求参数
const reqParams = {
  appid,
  type: 'miniProgram',
  projectPath: 'D:\\Code\\WxMini',
  privateKeyPath,
...
(async () => {
  const previewResult = await ci.preview({
    ...
    qrcodeFormat: 'image',
    qrcodeOutputDest: `./qrcode-${appid}-${buildId}.jpg`,
